...
attribute @e[type=minecraft:ender_dragon,limit=1] minecraft:generic.max_health base set 500
execute at @e[type=ender_dragon] run particle minecraft:explosion_emitter ~ ~ ~ 0.25 0.25 0.25 1 1 force
execute at @e[type=ender_dragon] run particle minecraft:explosion_emitter ~ ~ ~ 0.25 0.25 0.25 1 1 force
execute at @e[type=ender_dragon] run particle minecraft:explosion_emitter ~ ~ ~ 0.25 0.25 0.25 1 1 force
scoreboard players set @e[type=marker,tag=master] dragon_phase 2