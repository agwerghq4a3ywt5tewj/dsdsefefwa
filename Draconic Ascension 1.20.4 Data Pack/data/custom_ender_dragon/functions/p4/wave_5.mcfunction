bossbar set minecraft:phase_4_mobs name "Wave 5"
bossbar set minecraft:phase_4_mobs max 11

scoreboard players set @e[type=marker,tag=master] dragon_phase 11
...
summon wither_skeleton ~ ~ ~ {Tags:["phase_4_mob"],DeathLootTable:"minecraft:empty",HandItems:[{Count:1,id:"minecraft:stone_sword"}],HandDropChances:[0.0f,0.0f]}
summon wither_skeleton ~ ~ ~ {Tags:["phase_4_mob"],DeathLootTable:"minecraft:empty",HandItems:[{Count:1,id:"minecraft:stone_sword"}],HandDropChances:[0.0f,0.0f]}
summon wither_skeleton ~ ~ ~ {Tags:["phase_4_mob"],DeathLootTable:"minecraft:empty",HandItems:[{Count:1,id:"minecraft:stone_sword"}],HandDropChances:[0.0f,0.0f]}
summon wither_skeleton ~ ~ ~ {Tags:["phase_4_mob"],DeathLootTable:"minecraft:empty",HandItems:[{Count:1,id:"minecraft:stone_sword"}],HandDropChances:[0.0f,0.0f]}
summon wither_skeleton ~ ~ ~ {Tags:["phase_4_mob"],DeathLootTable:"minecraft:empty",HandItems:[{Count:1,id:"minecraft:stone_sword"}],HandDropChances:[0.0f,0.0f]}
