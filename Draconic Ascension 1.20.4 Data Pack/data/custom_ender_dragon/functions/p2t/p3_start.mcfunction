...
scoreboard players set @e[type=marker,tag=master] dragon_phase 5
...
execute in minecraft:the_end run summon shulker 0 100 0 {Color:10,Tags:["dragon_minion"],DeathLootTable:"minecraft:empty"}
execute in minecraft:the_end run summon shulker 0 100 0 {Color:10,Tags:["dragon_minion"],DeathLootTable:"minecraft:empty"}
execute in minecraft:the_end run summon shulker 0 100 0 {Color:10,Tags:["dragon_minion"],DeathLootTable:"minecraft:empty"}
execute in minecraft:the_end run summon shulker 0 100 0 {Color:10,Tags:["dragon_minion"],DeathLootTable:"minecraft:empty"}
execute in minecraft:the_end run summon shulker 0 100 0 {Color:10,Tags:["dragon_minion"],DeathLootTable:"minecraft:empty"}
