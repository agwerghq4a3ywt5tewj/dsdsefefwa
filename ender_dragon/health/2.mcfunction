execute \
    ...
    if predicate mcs_dragon:chance/0.15 \
...
execute \
    ...
    if predicate mcs_dragon:location/y/80..120 if predicate mcs_dragon:chance/0.2 \
...
execute \
    ...
    if predicate mcs_dragon:chance/0.03 if block ~ ~ ~ #minecraft:replaceable \
